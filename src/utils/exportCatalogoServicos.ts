...
export const exportCatalogoToExcel = () => {
  ...
  const servicosRows = catalogoData.servicos.map(servico => [
    ...
    servico.item,
    servico.tamanho || '-',
    servico.preco_limpeza ? formatCurrencyForExport(servico.preco_limpeza) : '-',
    servico.preco_impermeabilizacao ? formatCurrencyForExport(servico.preco_impermeabilizacao) : '-',
    servico.preco_limpeza_impermeabilizacao ? formatCurrencyForExport(servico.preco_limpeza_impermeabilizacao) : '-'
  ]);
  ...
  const alugueisRows = catalogoData.alugueis.map(aluguel => [
    ...
    formatCurrencyForExport(aluguel.preco),
    '-',
    '-'
  ]);
