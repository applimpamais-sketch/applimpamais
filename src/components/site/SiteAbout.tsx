        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative p-8 rounded-3xl bg-gradient-to-br from-primary/10 to-blue-400/5 border border-primary/20">
              ...
              <blockquote className="text-xl text-gray-300 italic mt-8 mb-6">
                Meu sofá estava com manchas de anos. A equipe da RC Limpa Mais fez um trabalho incrível — ficou como novo! Recomendo para todo mundo.
              </blockquote>
          ...
          >
            ...
            <p className="text-gray-400 mb-8 text-lg">
              A RC Limpa Mais é referência em limpeza e higienização de estofados em Belo Horizonte. 
              Utilizamos equipamentos profissionais e produtos biodegradáveis para garantir o melhor 
              resultado com segurança para sua família e pets.
            </p>
