...
const testimonials = [
  {
    ...
    text: `Já testei vários serviços de limpeza, mas nenhum se compara à ${PLATFORM_NAME}. A equipe é pontual, educada e o resultado é impecável. Meu sofá ficou irreconhecível!`,
  },
  {
    name: 'Ana Carolina',
    location: 'Buritis, BH',
  ...
  },
  {
    ...
    text: `Tenho um escritório e contrato a ${PLATFORM_NAME} mensalmente. As cadeiras e sofás ficam sempre impecáveis. Recomendo para qualquer empresa.`,
    ...
    <section className="py-20 bg-gray-900 overflow-hidden">
      <div className="container mx-auto px-4 mb-12">
        <div className="text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-primary-foreground mb-4">O Que Nossos Clientes Dizem</h2>
        </div>
      </div>

      <div className="flex gap-6 animate-marquee" style={{ '--duration': '40s' } as React.CSSProperties}>
        {[...testimonials, ...testimonials].map((t, i) => (
          <motion.div key={i} className="flex-shrink-0 w-[350px] p-6 rounded-2xl bg-gray-800/50 border border-gray-700/50">
